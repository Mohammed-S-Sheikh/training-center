                ...
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <form id="add-row-form" method="POST" action="{{ route('delegates.store') }}">
                            ...
                            <div class="form-group">
                                <input type="password" id="date-input" class="form-control date-picker" name="password" placeholder="كلمة المرور" value="{{ old('password') }}" required>
                                @if ($errors->has('password'))
                                <span class="text-danger">{{ $errors->first('password') }}</span>
                                @endif
                            </div>
                            <div class="form-group">
                                <input type="password" id="date-input" class="form-control date-picker" name="password_confirmation" placeholder="تأكيد كلمة المرور" value="{{ old('password_confirmation') }}" required>
